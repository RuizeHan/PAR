...
import numpy as np
from spectral_cluster.spectralcluster import constraint
from spectral_cluster.spectralcluster import custom_distance_kmeans
from spectral_cluster.spectralcluster import laplacian
from spectral_cluster.spectralcluster import refinement
from spectral_cluster.spectralcluster import utils
...
class SpectralClusterer:
  ...
  def predict(self, affinity, constraint_matrix=None):
